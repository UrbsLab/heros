...
def main(argv):
    ...
    row_index = ['rule 10', 'rule 50', 'rule 100', 'rule_500','rule_1000','test_selected_model_5','test_selected_model_10','test_selected_model_50','test_selected_model_100'] #'rule_post_compact'
    #for each in eval_point_list:
