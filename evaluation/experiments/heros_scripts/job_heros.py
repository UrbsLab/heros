...
def main(argv):
    ...
    # Save Tree-Only Initialized Rule Population (if applicable)
    if not min_output:
        if rule_pop_init == 'dt' or rule_pop_init == 'dt_bstrap':
            ...
            tree_init_rule_pop_df.to_csv(outputPath+'/rule_pop_tree_init_only.csv', index=False)
